...
STAR --runThreadN 4 --runMode genomeGenerate --genomeDir $INDEXDIR --genomeFastaFiles $GENOMEDIR/GCA_000001405.15_GRCh38_no_alt_analysis_set.fna --sjdbGTFfile $GENOMEDIR/gencode.v47.annotation.gtf --sjdbOverhang 99
